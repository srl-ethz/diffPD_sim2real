...
if __name__ == '__main__':
    for pressure, startendframes, init_x in zip([100, 150, 200, 250, 300, 350, 400, 450], [[59, 140], [67, 148], [79, 160], [77, 158], [155, 240], [78, 140], [50, 146], [40, 98]], [0.02, 0.04, 0.07, 0.1, 0.15, 0.21, 0.31, 0.46]):
        seed = 42
        ...
        # for 400mbar:
        #x_1 = np.ones(frame_num) *1.62#1.68#* 1.8 is working for 400mbar and E=130000 and E=263824 (same value!), but we have falting of the muscles, 1.68 for E=130000
        #x_2 = np.ones(frame_num) *0.69#*0.8
        ...
        #a0 = ndarray(variable_to_act(x_1,x_2))
        ...
        #ax.plot(times,x_qs_7, marker='o', markersize=4, label='Point 7')
        #ax.plot(times,x_qs_6, marker='o', markersize=4, label='Point 6')
