...
# Utility functions 
from utils import read_measurement_data, plot_opt_result, create_video_AC1 
### Import the simulation scene
from Environments.AC1_env import ArmEnv
...
if __name__ == '__main__':
    for pressure, startendframes, init_a in zip([100, 150, 200, 250, 300, 350, 400, 450], [[59, 140], [67, 148], [79, 160], [77, 158], [155, 240], [78, 140], [50, 146], [40, 98]], [1.05, 1.12, 1.19, 1.28, 1.40, 1.58, 1.80, 1.95]):
        ...
        create_video_AC1(folder,frame_num, hex_env.fibers, hex_env,qs_real,method,20,dt)
