# ------------------------------------------------------------------------------
# Benchmark against real beam (3cm x 3cm x 10cm) - Case C
# ------------------------------------------------------------------------------
...
if __name__ == '__main__':
    seed = 42
    np.random.seed(seed)
    folder = Path('Clamped_Beam_Case_C')
    ...
    tet_env = BeamEnv(seed, folder, tet_params,-0.51012,'C')
    ...
    hex_env = BeamEnv(seed, folder, hex_params,-0.51012,'C')
