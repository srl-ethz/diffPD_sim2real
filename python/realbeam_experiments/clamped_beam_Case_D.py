# ------------------------------------------------------------------------------
# Benchmark against real beam (3cm x 3cm x 10cm) - Case D
# ------------------------------------------------------------------------------
...
if __name__ == '__main__':
    seed = 42
    np.random.seed(seed)
    folder = Path('Clamped_Beam_Case_D')
    ...
    tet_env = BeamEnv(seed, folder, tet_params,-1.00062,'D')
    ...
    hex_env = BeamEnv(seed, folder, hex_params,-1.00062,'D')
