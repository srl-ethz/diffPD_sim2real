...
from py_diff_pd.core.py_diff_pd_core import Deformable2d, Mesh2d, StdRealMatrix
...
def test_actuation_2d(verbose):
    ...
    for j in range(cell_nums[1]):
        indices.append(3 * cell_nums[1] + j)
    deformable.AddActuation(1e3, [0.0, 1.0], indices)
