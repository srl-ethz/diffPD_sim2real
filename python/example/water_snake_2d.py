...
from py_diff_pd.common.controller import SharedOpenController, AdaOpenController, SnakeAdaOpenController
...
def main():
    ...
    optimizer = optim.Adam(list(controller.parameters()), lr=0.1)
