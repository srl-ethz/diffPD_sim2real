...
if __name__ == '__main__':
    ...
    if max_rel_tol_nums < len(rel_tols):
        print_warning('Rolling jelly data corrupted. Showing the first {} only.'.format(max_rel_tol_nums))
    ...
    fig.savefig(folder / 'rolling_jelly.pdf')
    fig.savefig(folder / 'rolling_jelly.png')
    ...
    fig_l_g.savefig(folder / 'rolling_jelly_loss_grad.pdf')
    fig_l_g.savefig(folder / 'rolling_jelly_loss_grad.png')
    plt.show()
