...
if __name__ == '__main__':
    ...
    ax_E.plot([1e7 for _ in range(opt_iters)], linestyle='--', label='Ground truth', color='tab:orange', linewidth=4)

    ax_nu = fig.add_subplot(132)
    ax_nu.set_position((0.41, 0.27, 0.25, 0.6))
    ax_nu.plot([0.45 for _ in range(opt_iters)], linestyle='--', label='Ground truth', color='tab:orange', linewidth=4)
